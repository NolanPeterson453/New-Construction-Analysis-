...
A full linear model was fit that used all predictors in the data set to estimate sale price of the home. Using step-wise selection with AIC as the criterion features were selected for either inclusion or removal in the model. 
